...
## Dataset can be taken from Kaggle: https://www.kaggle.com/soumikrakshit/anime-faces
IMG_H = 64
IMG_W = 64
...
def deconv_block(inputs, num_filters, kernel_size,strides , padding="same", bn=True):
    x = Conv2DTranspose(
        filters=num_filters,
...
def save_plot(examples, epoch, n):
    ...
    filename = f"/kaggle/working/generated_plot_epoch-{epoch+1}.png"
...
if __name__ == "__main__":
    ...
    # Dataset
    images_path = glob("../input/anime-faces/data/data/*")
